...
[10. Функциональные требования](#Функциональные)

[11. Карта пользовательских историй](#Карта)

[12. Defenition of Ready](#dor)

[13. Defenition of Done](#dod)

[14. BPMN бизнес-процессов](#BPMN)

[15. Модель предметной области](#Модель)

[16. Модель базы данных](#Модель_БД)

[17. Расчет нагрузки на БД](#Расчет)

[18. Выбор архитектуры](#Выбор)

[19. Acceptance Criteria](#Acceptance)

[20. Макет интерфейса](#Макет)

[21. Тест-кейсы](#Тест)

[22. Постановка для для разработчиков в Gherkin](#Gherkin)

[23.  Проектирование ресурсной модели Open API](#Open)
...
Минимальный: Скорость обслуживания не должна уменьшиться (текущую средняя скорость обслуживания 15 минут)

Максимальный: Скорость обслуживания должна вырасти на 30% (средняя скорость обслуживания должна составлять 10 минут)

Минимальный: Операционные затраты не должны вырасти как минимум (ежедневные операционные затраты ресторана 50 000 рублей)

Максимальный: Операционные затраты должны сократиться на 30% (ежедневные операционные затраты ресторана должны составить 35 000 рублей)
...
| №  | Требование                                                                                                                             | Категория                              | Источник             |
| -- | -------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- | -------------------- |
| 1  | Интеграция с платежной системой для осуществления оплаты через терминал                                                                | Совместимость                          | технолог             |
| 2  | Интеграция с системой заказа продуктов                                                                                                 | Совместимость                          | технолог             |
| 3  | Система должна поддерживать работу 24/7                                                                                                | Доступность                            | Продакт менеджер     |
| 4  | Система должна быть способной обрабатывать 5000 заказов в день                                                                         | Производительность                     | Продакт менеджер     |
| 5  | Система должна обеспечивать интеграцию с сервисами доставки для отправки заказов клиентам                                              | Совместимость                          | Продакт менеджер     |
| 6  | Система должна поддерживать масштабирование до 100 ресторанов                                                                          | Масштабируемость                       | Продакт менеджер     |
| 7  | Система должна использовать облачные сервисы, не требующие интеграции с текущей инфраструктурой                                        | Совместимость                          | Технический директор |
| 8  | Система должна поддерживать PC с операционной системой Windows                                                                         | Совместимость                          | Технический директор |
| 9  | Мобильное приложение должно быть доступно на IOS и Android                                                                             | Совместимость                          | Технический директор |
| 10 | Система по хранению продуктов должна быть написана с нуля                                                                              | Концептуальная целостность             | Технический директор |
| 11 | Необходима база данных для хранения информации о продуктах                                                                             | Особенности хранения данных            | Технический директор |
| 12 | Downtime системы не должен превышать 10 минут                                                                                          | Надежность                             | Технический директор |
| 13 | Система должна иметь систему оповещений о сбоях, например, Apex                                                                        | Поддерживаемость                       | Технический директор |
| 14 | Необходим стандартный мониторинг системы, например, Grafana.                                                                           | Поддерживаемость                       | Технический директор |
| 15 | Система должна выдерживать 5000 заказов в день и одновременно 100 сессий.<br>При масштабировании до 10000 сессий одновременно.         | Производительность<br>Масштабируемость | Технический директор |
| 16 | Система должна быть доступна на русском языке                                                                                          | Удобство использования                 | Технический директор |
| 17 | Для мобильного приложения должна быть поддержка СБП<br>Для терминала должна быть поддержка обычной оффлайн кассы приема кредитных карт | Совместимость                          | Технический директор |
