...
| шаг 2                | Выбрать "другое",<br>написать комментарий: Test<br>Отправить обращение нажав на кнопку | система отражает отобразить номер обращения и примерное время ответа менеджера              |
