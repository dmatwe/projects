...
***SOAP  (от англ. Simple Object Access Protocol*** — протокол доступа к объектам) — протокол (HTTP) обмена структурированными сообщениями в распределённой вычислительной среде (удаленный вызов). 
